...
const FilterMenu = () => {
   return (
    <div className='flex items-center justify-between w-full h-[48px] bg-white px-16 mt-8 '>
      <FilterMenuItem component ={
        <Input variant="unstyled" size="lg" leftSection={
      ...
      <FilterMenuItem component ={
        <MultiSelect variant="unstyled" size="lg" leftSection={
